        ...
        <div class="row px-3">
            <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
                ...
                <div class="card-body">
                    ...
                    <form class="form-box px-3" action="status.php" onsubmit="return sub();" method="post" enctype="multipart/form-data">
                        <div class="form-input">
                            <span><i class="fa fa-user-o"></i></span>
                            <input type="text" name="hp_license" id="hp_license" placeholder="Registration/License No." tabindex="" required>
                        </div>
						<div class="form-input">
                            <span><i class="fa fa-user-o"></i></span>
                            <input type="text" name="hp_name" id="hp_name" placeholder="Hospital Name" tabindex="" required>
                        </div>
						<div class="form-input">
                            <span><i class="fa fa-user-o"></i></span>
                            <input type="text" name="hp_type" id="hp_type" placeholder="Government / Private" tabindex="" required>
                        </div>
						<div class="form-input">
                            <span><i class="fa fa-user-o"></i></span>
                            <input type="text" name="hp_speciality" id="hp_speciality" placeholder="Speciality" tabindex="" required>
                        </div>
						<div class="form-input">
                            <span><i class="fa fa-user-o"></i></span>
                            <input type="text" name="hp_desc" id="hp_desc" placeholder="Description" tabindex="" required>
                        </div>
						<hr/>
                        <div class="form-input">
                        ...
                        <div class="form-input">
                            ...
                            <input type="password" name="hp_password" id="hp_password" placeholder="Password" required>
                        </div>
                        <div class="form-input">
                            <span><i class="fa fa-key"></i></span>
						...
						<div class="form-input">
                            ...
                            <input type="address" name="hp_address" id="hp_address" placeholder="Address" required>
                        </div>
						<div class="row">
							<div class="form-input col-sm-7">
								<span><i class="fa fa-map-marker"></i></span>
								<input type="address" name="hp_city" id="hp_city" placeholder="City" required>
							</div>
							<div class="form-input col-sm-5">
								<span><i class="fa fa-map-marker"></i></span>
								<input type="text" name="hp_district" id="hp_district" placeholder="District" required>
							</div>
						</div>
						<div class="row">
							<div class="form-input col-sm-7">
								<span><i class="fa fa-map-marker"></i></span>
								<input type="address" name="hp_state" id="hp_state" placeholder="State" required>
							</div>
							<div class="form-input col-sm-5">
								<span><i class="fa fa-map-marker"></i></span>
								<input type="number" name="hp_pincode" id="hp_pincode" placeholder="Pincode" required>
							</div>
						</div>
						<hr/>
						<div class="row pb-2">
							<div class="form-input col-sm-6">
								<span><i class="fa fa-file-image-o"></i>Supporting Documents</span>
							</div>
							<div class="form-input col-sm-6">
								<input class="pt-2 pl-3" type="file" name="hp_files" id="hp_files" required>
							</div>
							
						</div>
							<p class=" text-center">
								Document's size should be under <b>5MB</b>.
							</p>
						<hr/>
						...
						<br/>
                        <div class="mb-3">
                            <button type="submit" onclick="" class="btn btn-sm btn-primary btn-block text-uppercase" name="submit" id="submit">
                                Sign Up
                            </button>
                        </div>
						<div class="mb-3">
